...
Recomputed over **502 cartridges** (`docs/commons-catalog.json` `counts.cartridges`). The 2026-08 column is the figure the audit published, over the 326 project directories present at `f2cff0d7` (2026-08-06) — that denominator counted every directory under `projects/`, including the ones the Commons catalog does not publish, so the two denominators are not the same set. `~` marks a figure the audit stated approximately.

| Metric | Numerator | Denominator | Ratio | 2026-08 | Δ |
| :-- | --: | --: | --: | --: | --: |
| Cartridges declaring `project.engine: cadquery` | 480 | 502 | 95.6% | 300 / 326 = 92.0% | +3.6 pp |
...
| …of which declare `tolerance_by_material` | 469 | 502 | 93.4% | 294 / 326 = 90.2% | +3.2 pp |
| …of which declare `shrinkage_compensation` | 68 | 502 | 13.5% | 30 / 326 = 9.2% | +4.3 pp |
| …of which declare `recycled_material_toggle` | 98 | 502 | 19.5% | 16 / 326 = 4.9% | +14.6 pp |
...
| Studio strings translated across de/fr/pt/zh | 1508 | 1508 | 100.0% | ~992 / 1308 = 75.8% | +24.2 pp |
...
| Declared CDG interfaces per cartridge | 969 | 502 | 1.93 | — | new in 2026-09 |
| Cartridges exposing a `flange` interface | 49 | 502 | 9.8% | — | new in 2026-09 |
| Cartridges filed `domain: wearable` | 72 | 502 | 14.3% | — | new in 2026-09 |
| Cartridges whose README declares a Fashion Cabinet bridge | 53 | 502 | 10.6% | — | new in 2026-09 |
| Cartridges reachable from the public landing gallery | 502 | 502 | 100.0% | — | new in 2026-09 |
