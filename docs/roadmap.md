...
All 28 active projects now have `thumbnail`, `tags`, and `difficulty` fields. `glia-diagnostic` was the last project missing these — added as part of the P0.2 schema cleanup pass.
