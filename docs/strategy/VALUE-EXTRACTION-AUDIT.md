...
Recomputed over **495 cartridges** (`docs/commons-catalog.json` `counts.cartridges`). The 2026-08 column is the figure the audit published, over the 326 project directories present at `f2cff0d7` (2026-08-06) — that denominator counted every directory under `projects/`, including the ones the Commons catalog does not publish, so the two denominators are not the same set. `~` marks a figure the audit stated approximately.

| Metric | Numerator | Denominator | Ratio | 2026-08 | Δ |
| :-- | --: | --: | --: | --: | --: |
| Cartridges declaring `project.engine: cadquery` | 474 | 495 | 95.8% | 300 / 326 = 92.0% | +3.7 pp |
| Cartridges declaring ≥1 `camera_views` entry | 451 | 495 | 91.1% | 293 / 326 = 89.9% | +1.2 pp |
| Curated camera angles per cartridge | 1190 | 495 | 2.40 | 883 / 326 = 2.71 | -0.30 |
| Cartridges shipping ≥1 preset | 465 | 495 | 93.9% | 303 / 326 = 92.9% | +1.0 pp |
| Proven configurations (presets) per cartridge | 1470 | 495 | 2.97 | 1021 / 326 = 3.13 | -0.16 |
| Cartridges declaring ≥1 constraint | 399 | 495 | 80.6% | 287 / 326 = 88.0% | -7.4 pp |
| Bilingual constraints per cartridge | 758 | 495 | 1.53 | 555 / 326 = 1.70 | -0.17 |
| Cartridges carrying `hyperobject.material_awareness` | 483 | 495 | 97.6% | 310 / 326 = 95.1% | +2.5 pp |
| …of which declare `tolerance_by_material` | 463 | 495 | 93.5% | 294 / 326 = 90.2% | +3.4 pp |
| …of which declare `shrinkage_compensation` | 68 | 495 | 13.7% | 30 / 326 = 9.2% | +4.5 pp |
| …of which declare `recycled_material_toggle` | 98 | 495 | 19.8% | 16 / 326 = 4.9% | +14.9 pp |
| Cartridges declaring an `animations` block | 1 | 495 | 0.2% | 1 / 326 = 0.3% | -0.1 pp |
| CDG family keys with ≥1 member in the commons | 112 | 116 | 96.6% | 55 / 61 = 90.2% | +6.4 pp |
| Cartridges resolving to ≥1 CDG standard family | 209 | 495 | 42.2% | ~98 / 326 = 30.1% | +12.2 pp |
...
| Dual-engine cartridges (CadQuery B-Rep + OpenSCAD CSG) | 19 | 495 | 3.8% | — | new in 2026-09 |
| Cartridges declaring ≥1 CDG interface | 485 | 495 | 98.0% | — | new in 2026-09 |
| Declared CDG interfaces per cartridge | 939 | 495 | 1.90 | — | new in 2026-09 |
| Cartridges exposing a `flange` interface | 49 | 495 | 9.9% | — | new in 2026-09 |
| Cartridges filed `domain: wearable` | 72 | 495 | 14.5% | — | new in 2026-09 |
| Cartridges whose README declares a Fashion Cabinet bridge | 53 | 495 | 10.7% | — | new in 2026-09 |
| Cartridges reachable from the public landing gallery | 495 | 495 | 100.0% | — | new in 2026-09 |
| Landing-gallery entries the Commons catalog does not publish | 0 | 495 | 0.0% | — | new in 2026-09 |
| Cartridges offering STEP (B-Rep) export | 489 | 495 | 98.8% | — | new in 2026-09 |
| Cartridges carrying an explicit licence | 495 | 495 | 100.0% | — | new in 2026-09 |
| Cartridges carrying a `verification` block | 9 | 495 | 1.8% | — | new in 2026-09 |
