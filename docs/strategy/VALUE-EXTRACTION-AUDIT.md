...
Recomputed over **499 cartridges** (`docs/commons-catalog.json` `counts.cartridges`). The 2026-08 column is the figure the audit published, over the 326 project directories present at `f2cff0d7` (2026-08-06) — that denominator counted every directory under `projects/`, including the ones the Commons catalog does not publish, so the two denominators are not the same set. `~` marks a figure the audit stated approximately.

| Metric | Numerator | Denominator | Ratio | 2026-08 | Δ |
| :-- | --: | --: | --: | --: | --: |
| Cartridges declaring `project.engine: cadquery` | 477 | 499 | 95.6% | 300 / 326 = 92.0% | +3.6 pp |
| Cartridges declaring ≥1 `camera_views` entry | 455 | 499 | 91.2% | 293 / 326 = 89.9% | +1.3 pp |
| Curated camera angles per cartridge | 1206 | 499 | 2.42 | 883 / 326 = 2.71 | -0.29 |
| Cartridges shipping ≥1 preset | 469 | 499 | 94.0% | 303 / 326 = 92.9% | +1.0 pp |
| Proven configurations (presets) per cartridge | 1502 | 499 | 3.01 | 1021 / 326 = 3.13 | -0.12 |
| Cartridges declaring ≥1 constraint | 401 | 499 | 80.4% | 287 / 326 = 88.0% | -7.7 pp |
| Bilingual constraints per cartridge | 764 | 499 | 1.53 | 555 / 326 = 1.70 | -0.17 |
| Cartridges carrying `hyperobject.material_awareness` | 487 | 499 | 97.6% | 310 / 326 = 95.1% | +2.5 pp |
| …of which declare `tolerance_by_material` | 466 | 499 | 93.4% | 294 / 326 = 90.2% | +3.2 pp |
| …of which declare `shrinkage_compensation` | 68 | 499 | 13.6% | 30 / 326 = 9.2% | +4.4 pp |
| …of which declare `recycled_material_toggle` | 98 | 499 | 19.6% | 16 / 326 = 4.9% | +14.7 pp |
| Cartridges declaring an `animations` block | 1 | 499 | 0.2% | 1 / 326 = 0.3% | -0.1 pp |
| CDG family keys with ≥1 member in the commons | 113 | 116 | 97.4% | 55 / 61 = 90.2% | +7.2 pp |
| Cartridges resolving to ≥1 CDG standard family | 211 | 499 | 42.3% | ~98 / 326 = 30.1% | +12.2 pp |
...
| Dual-engine cartridges (CadQuery B-Rep + OpenSCAD CSG) | 20 | 499 | 4.0% | — | new in 2026-09 |
| Cartridges declaring ≥1 CDG interface | 489 | 499 | 98.0% | — | new in 2026-09 |
| Declared CDG interfaces per cartridge | 952 | 499 | 1.91 | — | new in 2026-09 |
| Cartridges exposing a `flange` interface | 49 | 499 | 9.8% | — | new in 2026-09 |
| Cartridges filed `domain: wearable` | 72 | 499 | 14.4% | — | new in 2026-09 |
| Cartridges whose README declares a Fashion Cabinet bridge | 53 | 499 | 10.6% | — | new in 2026-09 |
| Cartridges reachable from the public landing gallery | 499 | 499 | 100.0% | — | new in 2026-09 |
| Landing-gallery entries the Commons catalog does not publish | 0 | 499 | 0.0% | — | new in 2026-09 |
| Cartridges offering STEP (B-Rep) export | 491 | 499 | 98.4% | — | new in 2026-09 |
| Cartridges carrying an explicit licence | 499 | 499 | 100.0% | — | new in 2026-09 |
| Cartridges carrying a `verification` block | 11 | 499 | 2.2% | — | new in 2026-09 |
