...
export default function AdminShell({ auth }) {
    ...
    return (
        <div className="flex h-screen overflow-hidden bg-background">
            ...
            {/* Sidebar */}
            <aside className={`fixed inset-y-0 left-0 z-40 flex w-48 lg:w-56 flex-shrink-0 flex-col border-r border-border bg-card pl-safe transition-transform duration-200 md:relative md:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                {/* Brand */}
