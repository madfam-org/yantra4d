...
export default function AuthGate({ action, tier: requiredTier, children, fallback = null }: AuthGateProps) {
  ...
  if (action) {
    const accessControl = (manifest?.access_control || {}) as Record<string, string>
