...
interface TpmsTopologyControlProps {
    param: TpmsParam
    value: number | undefined
    onChange: (name: string, valArray: number[]) => void
    getLabel: (obj: Record<string, unknown> | null | undefined, key: string, lang: string) => string
    language: string
}

export default function TpmsTopologyControl({ param, value, onChange, getLabel, language }: TpmsTopologyControlProps) {
