...
function SidebarContent() {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-1 landscape:grid-cols-2 gap-2 border-t border-border pt-4">
        <Button
          type="button"
...
export default function StudioSidebar() {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <div data-testid="studio-sidebar" className="hidden lg:flex w-full h-full min-w-[20rem] bg-card p-4 flex-col gap-4 overflow-y-auto shrink-0">
        <SidebarContent />
      </div>
