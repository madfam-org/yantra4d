...
class TestBuildProjectUrl:
    ...
    def test_preset_with_params(self, app):
        with app.test_request_context(), patch.dict(os.environ, {"PUBLIC_STUDIO_URL": "https://example.com"}):
    ...
    def test_fallback_to_request_host(self, app):
        with app.test_request_context("http://localhost:5000/"), patch.dict(os.environ, {}, clear=False):
