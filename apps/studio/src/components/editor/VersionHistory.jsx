...
/**
 * VersionHistory — read-only git commit history browser.
 * Fetches the git log for a project and displays commits with
 * author, date, and message. Click to highlight (future: visual diff).
 *
 * @param {string} projectSlug - the project to fetch history for
 * @param {function} onClose - callback to close the history panel
 */
export default function VersionHistory({ projectSlug, onClose }) {
