...
function getStepLabel(step: Step, language: string): string {
...
export default function StepList({ steps, selectedIndex, onSelect, onAdd, onRemove, onReorder, language }: StepListProps) {
  return (
      ...
      <div className="flex flex-col gap-0.5 max-h-48 overflow-y-auto">
        {steps.map((step, i) => (
          <div
            ...
            onClick={() => onSelect(i)}
            onKeyDown={(e: React.KeyboardEvent) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onSelect(i) } }}
          >
            ...
            {i === selectedIndex && (
              <div className="flex items-center gap-0.5">
                <Button
                  ...
                  onClick={(e: React.MouseEvent) => { e.stopPropagation(); onReorder(i, -1) }}
                  disabled={i === 0}
                >
                ...
                <Button
                  ...
                  onClick={(e: React.MouseEvent) => { e.stopPropagation(); onRemove(i) }}
