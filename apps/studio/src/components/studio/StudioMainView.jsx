...
export default function StudioMainView({ compareMode, comparisonSlots, onAddComparisonSlot, onRemoveComparisonSlot, consoleSize, consoleCollapsed, onConsoleResize, onToggleConsole }) {
  const {
  ...
  const viewerContent = compareMode && comparisonSlots?.length > 0 ? (
