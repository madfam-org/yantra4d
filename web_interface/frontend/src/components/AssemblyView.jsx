...
export default function AssemblyView({ onHighlightParts, onSetCamera }) {
  ...
  const goTo = useCallback((idx) => {
    ...
    if (s.highlight_parts && onHighlightParts) onHighlightParts(s.highlight_parts)
    if (s.camera && onSetCamera) onSetCamera(s.camera)
  }, [steps, onHighlightParts, onSetCamera])
